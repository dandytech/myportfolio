        ...
        <SwiperSlide>
          <div className="lg:relative pb-10 h-[100vh]  w-full">
            ...
            <div className="flex lg:mt-10 justify-start  mt-5 md:flex-col items-center  px-3 md:ml-5 w-full md:mt-7 ">
              <div className="w-full h-full md:pb-40 md:right-14 absolute right-2  lg:top-0 lg:p-32 top-[200px]">
                <img
                  src={photo}
                  alt="photo"
                  className="md:w-full w-full lg:h-full  md:h-[65vh] object-cover h-[45vh]"
                />
              </div>
